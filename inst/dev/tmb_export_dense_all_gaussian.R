#!/usr/bin/env Rscript
# =============================================================================
# Fit RP-BNB model to export_dense_all.csv with Gaussian copula dependence
# Uses SML estimation
# =============================================================================
...
cat("=== Fitting RP-BNB (Gaussian Copula, SML) to export_dense_all.csv ===\n")
...
cat("\nGaussian copula captures dependence via a normal latent correlation.\n")
