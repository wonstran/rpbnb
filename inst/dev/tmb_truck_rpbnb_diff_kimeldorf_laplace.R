#!/usr/bin/env Rscript
# =============================================================================
# the rpbnb TMB engine -- truck crash RP-BNB, Kimeldorf (Clayton) copula, Laplace
# estimator.
#
...
# = 27,896 weighted by Clayton's 1.1, i.e. 30,686 against a default budget near
# 700,000, so the guard stays on with room to spare.
#
# Run from the package root:
#   library(rpbnb); source("inst/dev/truck_rpbnb_diff_kimeldorf_laplace.R")
# =============================================================================
