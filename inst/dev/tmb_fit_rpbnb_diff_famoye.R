#!/usr/bin/env Rscript
# =============================================================================
# the rpbnb TMB engine estimation demo -- DIFFERENT formulas, Famoye/Sarmanov dependence.
#
...
#   library(rpbnb); source("inst/dev/fit_rpbnb_diff_famoye.R")
# =============================================================================
...
# 12 kB per observation-draw (see TAPE_CALIBRATION / inst/dev/benchmark_memory.R).
...
data <- read.csv(system.file(
  "extdata", "rwm1984_bnb.csv", package = "rpbnb", mustWork = TRUE
))
