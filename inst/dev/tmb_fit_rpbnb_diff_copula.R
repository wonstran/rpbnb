#!/usr/bin/env Rscript
# =============================================================================
# the rpbnb TMB engine estimation demo -- DIFFERENT formulas, Frank COPULA dependence.
#
...
#   library(rpbnb); source("inst/dev/fit_rpbnb_diff_copula.R")
# =============================================================================
...
# inst/dev/benchmark_memory.R), so the same memory budget buys proportionally
