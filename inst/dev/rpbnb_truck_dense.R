...
# ONE control object -- the dense-data counterpart of inst/dev/rpbnb_truck_open.R.
#
...
#
#   2. FORMULAS.  Taken from inst/dev/tmb_truck_rpbnb_diff_famoye_dense.R: the two
...
#     Rscript inst/dev/rpbnb_truck_dense.R
# =============================================================================
...
tmb_method <- "sml"
# Famoye/Sarmanov, matching inst/dev/tmb_truck_rpbnb_diff_famoye_dense.R.
dependence <- "famoye"
...
# see inst/dev/tmb_truck_rpbnb_diff_famoye_dense.R's header for why (random
