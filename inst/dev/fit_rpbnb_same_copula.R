#!/usr/bin/env Rscript
# =============================================================================
# rpbnb estimation demo -- SAME formulas, Gaussian COPULA dependence.
#
...
#   Rscript inst/dev/fit_rpbnb_same_copula.R
# =============================================================================
...
cat("=== RP-BNB (same formulas, Gaussian copula) on rwm1984 health counts ===\n")
...
# here (NB dispersion vs random-coefficient scale), so dummies stay fixed.
...
resid_pdf <- file.path("results", "fit_rpbnb_same_copula_residuals.pdf")
