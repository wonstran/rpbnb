...
# trimmed version of inst/dev/rpbnb_truck_open.R with the TMB-engine side removed.
#
...
#     Rscript inst/dev/rpbnb_truck_dense_classic.R
# =============================================================================
...
# disable_parallel_gaussian, gradtol, restarts, max_threads, ...) do not apply.
