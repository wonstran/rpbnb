...
# Mirrors inst/dev/rpbnb_truck_dense_v2.R exactly -- does NOT edit that file.
# Same f1/f2, random_1/random_2, draws/seed/standardize/boundary_tests/control.
#
# Otherwise identical to rpbnb_truck_dense_v2.R. Multithreaded Gaussian-copula
# evaluation is the default since 0.4.6 (the SIGSEGV the old single-thread cap
# guarded against was fixed in 0.4.4), so Gaussian runs need no override here.
