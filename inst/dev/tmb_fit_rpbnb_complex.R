...
# using the rpbnb TMB engine (TMB backend). Compare the estimates against known ground-truth.
#
...
compare_sd <- function(prefix, random_spec) {
  ...
  # the rpbnb TMB engine uses log_sd as the scale label (normal distribution)
