#!/usr/bin/env Rscript
# =============================================================================
# Fit RP-BNB model to export_open_all.csv with Clayton copula dependence
# Uses SML estimation; Clayton captures lower-tail dependence
# =============================================================================
...
cat("=== Fitting RP-BNB (Clayton Copula, SML) to export_open_all.csv ===\n")
...
cat("\nClayton copula is useful for capturing lower-tail dependence.\n")
