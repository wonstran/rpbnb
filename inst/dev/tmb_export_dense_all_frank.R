#!/usr/bin/env Rscript
# =============================================================================
# Fit RP-BNB model to export_dense_all.csv with Frank copula dependence
# Uses Laplace approximation for memory efficiency
# =============================================================================
...
cat("=== Fitting RP-BNB (Frank Copula, Laplace) to export_dense_all.csv ===\n")
