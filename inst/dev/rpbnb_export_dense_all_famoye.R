#!/usr/bin/env Rscript
# =============================================================================
# Fit RP-BNB model (non-TMB) to export_dense_all.csv with Famoye dependence
# Uses BFGS optimization with normal random coefficients
# =============================================================================
...
cat("=== Fitting RP-BNB (non-TMB, Famoye) to export_dense_all.csv ===\n")
