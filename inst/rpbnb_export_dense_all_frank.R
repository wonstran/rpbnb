#!/usr/bin/env Rscript
# =============================================================================
# Fit RP-BNB model (non-TMB) to export_dense_all.csv with Frank copula
# Uses BFGS optimization, no random coefficients
# =============================================================================
...
cat("=== Fitting RP-BNB (non-TMB, Frank Copula) to export_dense_all.csv ===\n")
...
cat("Random coefficients: none (fixed-effects model)\n\n")
